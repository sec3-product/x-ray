...
public:
  enum {
    ...
    LINE_COMMENT = 59, BLOCK_COMMENT = 60, DOC_BLOCK_COMMENT = 61, INNER_LINE_DOC = 62, 
    INNER_BLOCK_DOC = 63, OUTER_LINE_DOC = 64, OUTER_BLOCK_DOC = 65, BLOCK_COMMENT_OR_DOC = 66, 
    SHEBANG = 67, WHITESPACE = 68, NEWLINE = 69, CHAR_LITERAL = 70, STRING_LITERAL = 71, 
    RAW_STRING_LITERAL = 72, BYTE_LITERAL = 73, BYTE_STRING_LITERAL = 74, 
    RAW_BYTE_STRING_LITERAL = 75, INTEGER_LITERAL = 76, DEC_LITERAL = 77, 
    HEX_LITERAL = 78, OCT_LITERAL = 79, BIN_LITERAL = 80, FLOAT_LITERAL = 81, 
    LIFETIME_OR_LABEL = 82, PLUS = 83, MINUS = 84, STAR = 85, SLASH = 86, 
    PERCENT = 87, CARET = 88, NOT = 89, AND = 90, OR = 91, ANDAND = 92, 
    OROR = 93, PLUSEQ = 94, MINUSEQ = 95, STAREQ = 96, SLASHEQ = 97, PERCENTEQ = 98, 
    CARETEQ = 99, ANDEQ = 100, OREQ = 101, SHLEQ = 102, SHREQ = 103, EQ = 104, 
    EQEQ = 105, NE = 106, GT = 107, LT = 108, GE = 109, LE = 110, AT = 111, 
    UNDERSCORE = 112, DOT = 113, DOTDOT = 114, DOTDOTDOT = 115, DOTDOTEQ = 116, 
    COMMA = 117, SEMI = 118, COLON = 119, PATHSEP = 120, RARROW = 121, FATARROW = 122, 
    POUND = 123, DOLLAR = 124, QUESTION = 125, LCURLYBRACE = 126, RCURLYBRACE = 127, 
    LSQUAREBRACKET = 128, RSQUAREBRACKET = 129, LPAREN = 130, RPAREN = 131
  };
