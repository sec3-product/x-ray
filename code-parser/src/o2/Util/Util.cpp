...
bool o2::isZeroOffsetTypeInRootType(const Type *rootType, const Type *elemType,
                                    const DataLayout &DL) {
...
llvm::StructType *
o2::getConvertedFlexibleArrayType(const llvm::StructType *ST,
...
// call void (...) %ptr()
bool o2::isCompatibleCall(const llvm::Instruction *indirectCall,
                          const llvm::Function *target) {
