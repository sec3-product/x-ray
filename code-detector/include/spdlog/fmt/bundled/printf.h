...
public:
    ...
    template <typename ArgFormatter = printf_arg_formatter<internal::buffer_range<Char>>>
    OutputIt format();
};
...
template <typename OutputIt, typename Char>
typename basic_printf_context<OutputIt, Char>::format_arg basic_printf_context<OutputIt, Char>::get_arg(
    unsigned arg_index) {
