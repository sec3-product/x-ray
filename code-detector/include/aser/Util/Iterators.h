...
template <typename NodeIDEdgeIteratorT, typename GraphT,
          typename ValueT = typename std::conditional<std::is_const<GraphT>::value,
              /*if true*/ std::pair<typename GraphT::EdgeT, typename GraphT::ConstNodePtrT>,
              /*if false*/std::pair<typename GraphT::EdgeT, typename GraphT::NodePtrT>>::type>
class NodeIDWrapperEdgeIterator
    : public llvm::iterator_adaptor_base<NodeIDWrapperEdgeIterator<NodeIDEdgeIteratorT, GraphT, ValueT>, NodeIDEdgeIteratorT,
        typename std::iterator_traits<NodeIDEdgeIteratorT>::iterator_category,
        ValueT> {
private:
    using BaseT = llvm::iterator_adaptor_base<NodeIDWrapperEdgeIterator<NodeIDEdgeIteratorT, GraphT>, NodeIDEdgeIteratorT,
