...
// only support looking up composite type, scalar type like int, float or pointer are not supported
...
const llvm::DICompositeType *getTypeMetaData(const llvm::Value *allocSite, AllocKind T,
