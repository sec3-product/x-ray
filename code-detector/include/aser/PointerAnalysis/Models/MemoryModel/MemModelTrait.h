...
struct MemModelTrait {
    ...
    // whether type information is necessary, we need type information to build the memory layout
    ...
    */
    ...
    inline static CGObjNode<MemModel> *allocateNullObj(MemModel &model, const llvm::Module *module) {
        return model.template allocNullObj<PT>(module);
    }

    template <typename PT>
    inline static CGObjNode<MemModel> *allocateUniObj(MemModel &model, const llvm::Module *module) {
        return model.template allocUniObj<PT>(module);
    }

    template <typename PT>
    inline static CGObjNode<MemModel> *allocateFunction(MemModel &model, const llvm::Function *fun) {
    ...
    template <typename PT>
    inline static CGObjNode<MemModel> *allocateStackObj(MemModel &model, const CtxTy *context,
    ...
    template <typename PT>
    inline static CGObjNode<MemModel> *allocateHeapObj(MemModel &model, const CtxTy *context,
    ...
    template <typename PT>
    inline static CGObjNode<MemModel> *allocateAnonObj(MemModel &model, const CtxTy *context,
                                                              const llvm::DataLayout &DL, llvm::Type *T,
    ...
    template <typename PT>
    inline static CGObjNode<MemModel> *indexObject(MemModel &model, const ObjectTy *obj,
