; ModuleID = 'basic_c_tests/struct-assignment-direct.c'
source_filename = "basic_c_tests/struct-assignment-direct.c"
...
define dso_local i32 @main() #0 !dbg !9 {
  ...
  %9 = getelementptr inbounds %struct.s, %struct.s* %2, i32 0, i32 1, !dbg !32
  store i32 %8, i32* %9, align 8, !dbg !33
  %10 = bitcast %struct.s* %3 to i8*, !dbg !34
  %11 = bitcast %struct.s* %2 to i8*, !dbg !34
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %10, i8* align 8 %11, i64 16, i1 false), !dbg !34
  %12 = getelementptr inbounds %struct.s, %struct.s* %3, i32 0, i32 0, !dbg !35
  %13 = load i32*, i32** %12, align 8, !dbg !35
  %14 = bitcast i32* %13 to i8*, !dbg !35
  %15 = getelementptr inbounds %struct.s, %struct.s* %2, i32 0, i32 0, !dbg !35
...
!1 = !DIFile(filename: "basic_c_tests/struct-assignment-direct.c", directory: "/home/peiming/Documents/Projects/LLVMRace/TestCases/PTABen")
!2 = !{}
!3 = !{!4}
...
!31 = !DILocation(line: 19, column: 9, scope: !9)
!32 = !DILocation(line: 19, column: 5, scope: !9)
!33 = !DILocation(line: 19, column: 7, scope: !9)
!34 = !DILocation(line: 20, column: 7, scope: !9)
!35 = !DILocation(line: 21, column: 2, scope: !9)
!36 = !DILocation(line: 22, column: 2, scope: !9)
