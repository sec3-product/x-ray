...
void PreProcPassManagerBuilder::addFunctionSimplificationPasses(legacy::PassManagerBase &MPM) {
    ...
    // Combine silly seq's
    // TODO: we still want instruction combine, but the instcombine should not delete the bitcast after heap allocation
...
void PreProcPassManagerBuilder::populatePreProcessingModuleManager(llvm::legacy::PassManagerBase &MPM) {
