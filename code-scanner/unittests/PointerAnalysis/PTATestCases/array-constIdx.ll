; ModuleID = 'basic_c_tests/array-constIdx.c'
source_filename = "basic_c_tests/array-constIdx.c"
...
define dso_local i32 @main() #0 !dbg !9 {
  ...
  %9 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 0, !dbg !33
  %10 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %9, i32 0, i32 0, !dbg !33
  %11 = load i32*, i32** %10, align 16, !dbg !33
  %12 = bitcast i32* %11 to i8*, !dbg !33
  %13 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 1, !dbg !33
  %14 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %13, i32 0, i32 1, !dbg !33
  %15 = load i32*, i32** %14, align 8, !dbg !33
  %16 = bitcast i32* %15 to i8*, !dbg !33
  call void @__aser_no_alias__(i8* %12, i8* %16), !dbg !33
  %17 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 0, !dbg !34
  %18 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %17, i32 0, i32 0, !dbg !34
  %19 = load i32*, i32** %18, align 16, !dbg !34
  %20 = bitcast i32* %19 to i8*, !dbg !34
  %21 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 1, !dbg !34
  %22 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %21, i32 0, i32 0, !dbg !34
  %23 = load i32*, i32** %22, align 16, !dbg !34
  %24 = bitcast i32* %23 to i8*, !dbg !34
  call void @__aser_alias__(i8* %20, i8* %24), !dbg !34
  ret i32 0, !dbg !35
}
...
!1 = !DIFile(filename: "basic_c_tests/array-constIdx.c", directory: "/home/peiming/Documents/Projects/LLVMRace/TestCases/PTABen")
!2 = !{}
!3 = !{!4}
