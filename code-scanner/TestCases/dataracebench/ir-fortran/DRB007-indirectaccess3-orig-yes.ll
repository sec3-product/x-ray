...
@.C343_MAIN_ = internal constant [60 x i8] c"micro-benchmarks-fortran/DRB007-indirectaccess3-orig-yes.f95"
...
@_drb007_0_ = common global %struct_drb007_0_ zeroinitializer, align 64, !dbg !7, !dbg !14

; Function Attrs: noinline
define float @drb007_() #0 {
.L.entry:
  ret float undef
}
...
L.LB2_403:                                        ; preds = %L.entry
  ...
  %158 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !56
...
L.LB2_372:                                        ; preds = %L.LB2_372, %L.LB2_403
  ...
  %168 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !57
...
L.LB3_336:                                        ; preds = %L.LB3_508
  ...
  %1 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !80
  ...
  %5 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !80
...
L.LB3_388:                                        ; preds = %L.LB3_388, %L.LB3_545
  ...
  %39 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !82
  ...
  %48 = bitcast %struct_drb007_0_* @_drb007_0_ to i8*, !dbg !83
...
!2 = distinct !DISubprogram(name: "drb007_indirectaccess3_orig_yes", scope: !4, file: !3, line: 35, type: !30, scopeLine: 35, spFlags: DISPFlagDefinition | DISPFlagMainSubprogram, unit: !4)
!3 = !DIFile(filename: "micro-benchmarks-fortran/DRB007-indirectaccess3-orig-yes.f95", directory: "/workspaces/LLVMRace/TestCases/dataracebench")
...
!9 = !DIModule(scope: !4, name: "drb007")
