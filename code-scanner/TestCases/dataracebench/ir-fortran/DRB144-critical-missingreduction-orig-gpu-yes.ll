; ModuleID = '/tmp/DRB144-critical-missingreduction-orig-gpu-yes-8160da.ll'
source_filename = "/tmp/DRB144-critical-missingreduction-orig-gpu-yes-8160da.ll"
...
@.C338_MAIN_ = internal constant [74 x i8] c"micro-benchmarks-fortran/DRB144-critical-missingreduction-orig-gpu-yes.f95"
@.C306_MAIN_ = internal constant i32 28
@.C317_MAIN_ = internal constant i32 200
@.C285_MAIN_ = internal constant i32 1
@.C283_MAIN_ = internal constant i32 0
@.C317___nv_MAIN__F1L18_1 = internal constant i32 200
@.C285___nv_MAIN__F1L18_1 = internal constant i32 1
@.C283___nv_MAIN__F1L18_1 = internal constant i32 0
@.C317___nv_MAIN_F1L19_2 = internal constant i32 200
...
L.LB1_375:                                        ; preds = %L.entry
  call void @llvm.dbg.declare(metadata i32* %var_307, metadata !29, metadata !DIExpression()), !dbg !22
  store i32 0, i32* %var_307, align 4, !dbg !30
  %3 = bitcast i32* %var_307 to i8*, !dbg !31
  ...
  call void @__nv_MAIN__F1L18_1_(i32* %__gtid_MAIN__384, i64* null, i64* %5), !dbg !31
  call void (...) @_mp_bcs_nest(), !dbg !32
  %6 = bitcast i32* @.C306_MAIN_ to i8*, !dbg !32
  %7 = bitcast [74 x i8]* @.C338_MAIN_ to i8*, !dbg !32
  %8 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !32
  call void (i8*, i8*, i64, ...) %8(i8* %6, i8* %7, i64 74), !dbg !32
  ...
  %14 = load i32, i32* %var_307, align 4, !dbg !32
...
define internal void @__nv_MAIN__F1L18_1_(i32* %__nv_MAIN__F1L18_1Arg0, i64* %__nv_MAIN__F1L18_1Arg1, i64* %__nv_MAIN__F1L18_1Arg2) #0 !dbg !34 {
L.entry:
  %.uplevelArgPack0002_405 = alloca %astruct.dt115, align 8
  call void @llvm.dbg.declare(metadata i32* %__nv_MAIN__F1L18_1Arg0, metadata !35, metadata !DIExpression()), !dbg !36
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN__F1L18_1Arg1, metadata !37, metadata !DIExpression()), !dbg !36
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN__F1L18_1Arg2, metadata !38, metadata !DIExpression()), !dbg !36
...
L.LB2_311:                                        ; preds = %L.LB2_400
  %0 = load i64, i64* %__nv_MAIN__F1L18_1Arg2, align 8, !dbg !44
  %1 = bitcast %astruct.dt115* %.uplevelArgPack0002_405 to i64*, !dbg !44
  store i64 %0, i64* %1, align 8, !dbg !44
  %2 = bitcast void (i32*, i64*, i64*)* @__nv_MAIN_F1L19_2_ to i64*, !dbg !44
...
L.LB2_336:                                        ; preds = %L.LB2_311
  ret void, !dbg !45
}

define internal void @__nv_MAIN_F1L19_2_(i32* %__nv_MAIN_F1L19_2Arg0, i64* %__nv_MAIN_F1L19_2Arg1, i64* %__nv_MAIN_F1L19_2Arg2) #0 !dbg !46 {
L.entry:
  %__gtid___nv_MAIN_F1L19_2__440 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %__nv_MAIN_F1L19_2Arg0, metadata !47, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN_F1L19_2Arg1, metadata !49, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN_F1L19_2Arg2, metadata !50, metadata !DIExpression()), !dbg !48
  ...
  %0 = load i32, i32* %__nv_MAIN_F1L19_2Arg0, align 4, !dbg !56
  store i32 %0, i32* %__gtid___nv_MAIN_F1L19_2__440, align 4, !dbg !56
  br label %L.LB4_423

L.LB4_423:                                        ; preds = %L.entry
  br label %L.LB4_314

L.LB4_314:                                        ; preds = %L.LB4_423
  br label %L.LB4_315
...
L.LB4_316:                                        ; preds = %L.LB4_315
  ...
  store i32 1, i32* %.i0001p_320, align 4, !dbg !57
  store i32 200, i32* %.i0002p_321, align 4, !dbg !57
  store i32 1, i32* %.i0003p_322, align 4, !dbg !57
  %1 = load i32, i32* %.i0001p_320, align 4, !dbg !57
  ...
  %2 = load i32, i32* %.i0002p_321, align 4, !dbg !57
  store i32 %2, i32* %.du0001_353, align 4, !dbg !57
  %3 = load i32, i32* %.i0002p_321, align 4, !dbg !57
  ...
  %5 = load i32, i32* %.i0001p_320, align 4, !dbg !57
  ...
  %9 = load i32, i32* %__gtid___nv_MAIN_F1L19_2__440, align 4, !dbg !57
  %10 = bitcast i32* %.i0000p_319 to i64*, !dbg !57
  ...
  store i32 %18, i32* %i_318, align 4, !dbg !57
  %19 = load i32, i32* %i_318, align 4, !dbg !57
...
L.LB4_490:                                        ; preds = %L.LB4_316
  ...
  store i32 %27, i32* %i_318, align 4, !dbg !57
  ...
  %43 = bitcast i32* %.i0002p_321 to i8*, !dbg !57
...
L.LB4_466:                                        ; preds = %L.LB4_490
  %47 = bitcast void (i32*, i64*, i64*)* @__nv_MAIN_F1L20_3_ to i64*, !dbg !57
...
L.LB4_351:                                        ; preds = %L.LB4_466, %L.LB4_316
  %49 = load i32, i32* %__gtid___nv_MAIN_F1L19_2__440, align 4, !dbg !59
  call void @__kmpc_for_static_fini(i64* null, i32 %49), !dbg !59
  br label %L.LB4_333

L.LB4_333:                                        ; preds = %L.LB4_351
  br label %L.LB4_334
...
define internal void @__nv_MAIN_F1L20_3_(i32* %__nv_MAIN_F1L20_3Arg0, i64* %__nv_MAIN_F1L20_3Arg1, i64* %__nv_MAIN_F1L20_3Arg2) #0 !dbg !9 {
L.entry:
  %__gtid___nv_MAIN_F1L20_3__511 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %__nv_MAIN_F1L20_3Arg0, metadata !60, metadata !DIExpression()), !dbg !61
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN_F1L20_3Arg1, metadata !62, metadata !DIExpression()), !dbg !61
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN_F1L20_3Arg2, metadata !63, metadata !DIExpression()), !dbg !61
  ...
  %0 = load i32, i32* %__nv_MAIN_F1L20_3Arg0, align 4, !dbg !69
  store i32 %0, i32* %__gtid___nv_MAIN_F1L20_3__511, align 4, !dbg !69
  br label %L.LB6_494

L.LB6_494:                                        ; preds = %L.entry
  br label %L.LB6_325

L.LB6_325:                                        ; preds = %L.LB6_494
  store i32 0, i32* %.i0004p_327, align 4, !dbg !70
  %1 = bitcast i64* %__nv_MAIN_F1L20_3Arg2 to i8*, !dbg !70
  ...
  call void @llvm.dbg.declare(metadata i32* %i_326, metadata !71, metadata !DIExpression()), !dbg !69
  store i32 %5, i32* %i_326, align 4, !dbg !70
  %6 = bitcast i64* %__nv_MAIN_F1L20_3Arg2 to i8*, !dbg !70
  ...
  %11 = bitcast i64* %__nv_MAIN_F1L20_3Arg2 to i8*, !dbg !70
  ...
  %17 = bitcast i64* %__nv_MAIN_F1L20_3Arg2 to i8*, !dbg !70
  ...
  %25 = load i32, i32* %__gtid___nv_MAIN_F1L20_3__511, align 4, !dbg !70
  %26 = bitcast i32* %.i0004p_327 to i64*, !dbg !70
  ...
  store i32 %34, i32* %i_326, align 4, !dbg !70
  %35 = load i32, i32* %i_326, align 4, !dbg !70
...
L.LB6_529:                                        ; preds = %L.LB6_325
  %39 = load i32, i32* %.dX0002p_369, align 4, !dbg !70
  store i32 %39, i32* %i_326, align 4, !dbg !70
...
L.LB6_363:                                        ; preds = %L.LB6_373, %L.LB6_325
  %66 = load i32, i32* %__gtid___nv_MAIN_F1L20_3__511, align 4, !dbg !69
  call void @__kmpc_for_static_fini(i64* null, i32 %66), !dbg !69
  br label %L.LB6_332

L.LB6_332:                                        ; preds = %L.LB6_363
  ret void, !dbg !69
}
...
!3 = !DIFile(filename: "micro-benchmarks-fortran/DRB144-critical-missingreduction-orig-gpu-yes.f95", directory: "/workspaces/LLVMRace/TestCases/dataracebench")
!4 = !{}
!5 = !{!6}
!6 = !DIGlobalVariableExpression(var: !7, expr: !DIExpression())
!7 = distinct !DIGlobalVariable(name: "__cs_unspc", scope: !8, type: !14, isLocal: false, isDefinition: true)
!8 = distinct !DICommonBlock(scope: !9, declaration: !7, name: "__cs_unspc")
!9 = distinct !DISubprogram(name: "__nv_MAIN_F1L20_3", scope: !2, file: !3, line: 20, type: !10, scopeLine: 20, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2)
...
!18 = distinct !DISubprogram(name: "drb144_atomiccritical_orig_gpu_yes", scope: !2, file: !3, line: 11, type: !19, scopeLine: 11, spFlags: DISPFlagDefinition | DISPFlagMainSubprogram, unit: !2)
...
!30 = !DILocation(line: 16, column: 1, scope: !18)
!31 = !DILocation(line: 26, column: 1, scope: !18)
!32 = !DILocation(line: 28, column: 1, scope: !18)
!33 = !DILocalVariable(scope: !18, file: !3, type: !12, flags: DIFlagArtificial)
!34 = distinct !DISubprogram(name: "__nv_MAIN__F1L18_1", scope: !2, file: !3, line: 18, type: !10, scopeLine: 18, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2)
!35 = !DILocalVariable(name: "__nv_MAIN__F1L18_1Arg0", arg: 1, scope: !34, file: !3, type: !12)
!36 = !DILocation(line: 0, scope: !34)
!37 = !DILocalVariable(name: "__nv_MAIN__F1L18_1Arg1", arg: 2, scope: !34, file: !3, type: !13)
!38 = !DILocalVariable(name: "__nv_MAIN__F1L18_1Arg2", arg: 3, scope: !34, file: !3, type: !13)
...
!44 = !DILocation(line: 19, column: 1, scope: !34)
!45 = !DILocation(line: 26, column: 1, scope: !34)
!46 = distinct !DISubprogram(name: "__nv_MAIN_F1L19_2", scope: !2, file: !3, line: 19, type: !10, scopeLine: 19, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2)
!47 = !DILocalVariable(name: "__nv_MAIN_F1L19_2Arg0", arg: 1, scope: !46, file: !3, type: !12)
!48 = !DILocation(line: 0, scope: !46)
!49 = !DILocalVariable(name: "__nv_MAIN_F1L19_2Arg1", arg: 2, scope: !46, file: !3, type: !13)
!50 = !DILocalVariable(name: "__nv_MAIN_F1L19_2Arg2", arg: 3, scope: !46, file: !3, type: !13)
...
!56 = !DILocation(line: 25, column: 1, scope: !46)
!57 = !DILocation(line: 20, column: 1, scope: !46)
!58 = !DILocalVariable(name: "i", scope: !46, file: !3, type: !12)
!59 = !DILocation(line: 24, column: 1, scope: !46)
!60 = !DILocalVariable(name: "__nv_MAIN_F1L20_3Arg0", arg: 1, scope: !9, file: !3, type: !12)
!61 = !DILocation(line: 0, scope: !9)
!62 = !DILocalVariable(name: "__nv_MAIN_F1L20_3Arg1", arg: 2, scope: !9, file: !3, type: !13)
!63 = !DILocalVariable(name: "__nv_MAIN_F1L20_3Arg2", arg: 3, scope: !9, file: !3, type: !13)
