; ModuleID = '/tmp/DRB169-workshare-orig-yes-77b22c.ll'
source_filename = "/tmp/DRB169-workshare-orig-yes-77b22c.ll"
...
@.C328_MAIN_ = internal constant [54 x i8] c"micro-benchmarks-fortran/DRB169-workshare-orig-yes.f95"
@.C330_MAIN_ = internal constant i32 34
...
L.LB1_362:                                        ; preds = %L.LB1_344
  %17 = bitcast void (i32*, i64*, i64*)* @__nv_MAIN__F1L22_1_ to i64*, !dbg !25
...
L.LB1_388:                                        ; preds = %L.LB1_362
  ...
  %22 = bitcast [54 x i8]* @.C328_MAIN_ to i8*, !dbg !28
  %23 = bitcast void (...)* @f90io_src_info03a to void (i8*, i8*, i64, ...)*, !dbg !28
  call void (i8*, i8*, i64, ...) %23(i8* %21, i8* %22, i64 54), !dbg !28
...
define internal void @__nv_MAIN__F1L22_1_(i32* %__nv_MAIN__F1L22_1Arg0, i64* %__nv_MAIN__F1L22_1Arg1, i64* %__nv_MAIN__F1L22_1Arg2) #0 !dbg !30 {
L.entry:
  %__gtid___nv_MAIN__F1L22_1__398 = alloca i32, align 4
  %.s0000_393 = alloca i32, align 4
  %.s0001_394 = alloca i32, align 4
  %.s0002_413 = alloca i32, align 4
  %.s0003_414 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %__nv_MAIN__F1L22_1Arg0, metadata !34, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN__F1L22_1Arg1, metadata !36, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.declare(metadata i64* %__nv_MAIN__F1L22_1Arg2, metadata !37, metadata !DIExpression()), !dbg !35
  ...
  %0 = load i32, i32* %__nv_MAIN__F1L22_1Arg0, align 4, !dbg !46
  store i32 %0, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !46
  br label %L.LB2_392
...
L.LB2_319:                                        ; preds = %L.LB2_316
  ...
  %1 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !47
...
L.LB2_422:                                        ; preds = %L.LB2_319
  %4 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i8*, !dbg !47
  ...
  %9 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i32**, !dbg !47
  %10 = load i32*, i32** %9, align 8, !dbg !47
  store i32 %8, i32* %10, align 4, !dbg !47
  %11 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i32**, !dbg !48
  %12 = load i32*, i32** %11, align 8, !dbg !48
  %13 = load i32, i32* %12, align 4, !dbg !48
  %14 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i8*, !dbg !48
  ...
  %20 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i32**, !dbg !48
  %21 = load i32*, i32** %20, align 8, !dbg !48
  store i32 %19, i32* %21, align 4, !dbg !48
  %22 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !49
  store i32 %22, i32* %.s0000_393, align 4, !dbg !49
  store i32 1, i32* %.s0001_394, align 4, !dbg !49
  %23 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !49
  call void @__kmpc_end_single(i64* null, i32 %23), !dbg !49
  br label %L.LB2_340

L.LB2_340:                                        ; preds = %L.LB2_422, %L.LB2_319
  %24 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !49
  call void @__kmpc_barrier(i64* null, i32 %24), !dbg !49
  %25 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !49
  call void @__kmpc_barrier(i64* null, i32 %25), !dbg !49
  br label %L.LB2_320
...
L.LB2_323:                                        ; preds = %L.LB2_320
  ...
  %26 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !50
  %27 = call i32 @__kmpc_single(i64* null, i32 %26), !dbg !50
  %28 = icmp eq i32 %27, 0, !dbg !50
  br i1 %28, label %L.LB2_341, label %L.LB2_423, !dbg !50

L.LB2_423:                                        ; preds = %L.LB2_323
  %29 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i32**, !dbg !50
  %30 = load i32*, i32** %29, align 8, !dbg !50
  %31 = load i32, i32* %30, align 4, !dbg !50
  %32 = mul nsw i32 %31, 2, !dbg !50
  %33 = bitcast i64* %__nv_MAIN__F1L22_1Arg2 to i8*, !dbg !50
  %34 = getelementptr i8, i8* %33, i64 24, !dbg !50
  %35 = bitcast i8* %34 to i32**, !dbg !50
  %36 = load i32*, i32** %35, align 8, !dbg !50
  store i32 %32, i32* %36, align 4, !dbg !50
  %37 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !51
  store i32 %37, i32* %.s0002_413, align 4, !dbg !51
  store i32 1, i32* %.s0003_414, align 4, !dbg !51
  %38 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !51
  call void @__kmpc_end_single(i64* null, i32 %38), !dbg !51
  br label %L.LB2_341

L.LB2_341:                                        ; preds = %L.LB2_423, %L.LB2_323
  %39 = load i32, i32* %__gtid___nv_MAIN__F1L22_1__398, align 4, !dbg !51
  call void @__kmpc_barrier(i64* null, i32 %39), !dbg !51
  br label %L.LB2_324
...
!3 = !DIFile(filename: "micro-benchmarks-fortran/DRB169-workshare-orig-yes.f95", directory: "/workspaces/LLVMRace/TestCases/dataracebench")
!4 = !{}
!5 = distinct !DISubprogram(name: "drb169_workshare_orig_yes", scope: !2, file: !3, line: 13, type: !6, scopeLine: 13, spFlags: DISPFlagDefinition | DISPFlagMainSubprogram, unit: !2)
...
!18 = !DILocation(line: 36, column: 1, scope: !5)
...
!23 = !DILocation(line: 20, column: 1, scope: !5)
...
!28 = !DILocation(line: 34, column: 1, scope: !5)
!29 = !DILocalVariable(scope: !5, file: !3, type: !9, flags: DIFlagArtificial)
!30 = distinct !DISubprogram(name: "__nv_MAIN__F1L22_1", scope: !2, file: !3, line: 22, type: !31, scopeLine: 22, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2)
!31 = !DISubroutineType(types: !32)
!32 = !{null, !9, !33, !33}
!33 = !DIBasicType(name: "integer*8", size: 64, align: 64, encoding: DW_ATE_signed)
!34 = !DILocalVariable(name: "__nv_MAIN__F1L22_1Arg0", arg: 1, scope: !30, file: !3, type: !9)
!35 = !DILocation(line: 0, scope: !30)
!36 = !DILocalVariable(name: "__nv_MAIN__F1L22_1Arg1", arg: 2, scope: !30, file: !3, type: !33)
!37 = !DILocalVariable(name: "__nv_MAIN__F1L22_1Arg2", arg: 3, scope: !30, file: !3, type: !33)
...
!46 = !DILocation(line: 31, column: 1, scope: !30)
!47 = !DILocation(line: 24, column: 1, scope: !30)
!48 = !DILocation(line: 25, column: 1, scope: !30)
!49 = !DILocation(line: 26, column: 1, scope: !30)
