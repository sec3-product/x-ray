...
|-------------|---------------------------|--------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| 1004        | **IntegerUnderflow**       | Detects potential underflows in subtraction operations that could lead to erroneous behavior.    | [Understanding Arithmetic Overflow/Underflows in Rust and Solana](https://www.sec3.dev/blog/understanding-arithmetic-overflow-underflows-in-rust-and-solana-smart-contracts) |
| 1003        | **IntegerAddOverflow**     | Identifies addition operations that may result in overflows, causing unexpected outcomes.        | [Understanding Arithmetic Overflow/Underflows in Rust and Solana](https://www.sec3.dev/blog/understanding-arithmetic-overflow-underflows-in-rust-and-solana-smart-contracts) |
| 1005        | **IntegerMulOverflow**     | Detects multiplication operations that could overflow, leading to incorrect calculations.        | [Understanding Arithmetic Overflow/Underflows in Rust and Solana](https://www.sec3.dev/blog/understanding-arithmetic-overflow-underflows-in-rust-and-solana-smart-contracts) |
| 1006        | **IntegerDivOverflow**     | Identifies division operations that may overflow, which could corrupt the program’s logic.       | [Understanding Arithmetic Overflow/Underflows in Rust and Solana](https://www.sec3.dev/blog/understanding-arithmetic-overflow-underflows-in-rust-and-solana-smart-contracts) |
