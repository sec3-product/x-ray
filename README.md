...
| 1016        | **ArbitraryCPI**           | Detects potential CPI calls to arbitrary program accounts without proper validation.             | [Arbitrary CPI Calls](https://github.com/coral-xyz/sealevel-attacks/tree/master/programs/5-arbitrary-cpi) |
