...
CLANG_OPTIONS="-DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX \
    ...
    -DLLVM_ENABLE_PROJECTS='clang;openmp;compiler-rt;lld;mlir' \
...
#echo "Start building smallrace..."
#cd /build/smallrace
#mkdir -p build && cd build
#cmake -DCMAKE_BUILD_TYPE=Release \
#      -DLLVM_DIR=$INSTALL_PREFIX/lib/cmake/llvm \
#      -DMLIR_DIR=$INSTALL_PREFIX/lib/cmake/mlir \
#      -DENABLE_TEST=Off ..
#make -j $(nproc)
#if [ $? -ne 0 ]; then
#    exit 1
#fi
#echo "Finish building smallrace..."
