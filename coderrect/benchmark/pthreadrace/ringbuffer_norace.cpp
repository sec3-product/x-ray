// @purpose a safe ringbuffer implementation
// @dataRaces 0
// @deadlocks 0
// @orderViolations 0
// @misMatchedAPI 0
...
namespace pthreadrace {
    ...
    private:
        ...
        size_t capacity_;
    public:
        RingBufferSafe(size_t capacity) : capacity_(capacity) {
            if (capacity == 0)
...
static void *Producer(void *rbuf) {
    auto *rbuf_ptr = (pthreadrace::RingBufferSafe*)rbuf;
    int i = 0;
    while (true) {
...
int main() {
    pthreadrace::RingBufferSafe rbuf(1024);
    int rc;
