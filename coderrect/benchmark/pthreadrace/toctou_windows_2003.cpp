// @purpose toctou based on description of security vulnerability in windows: https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2003-0813
// @toctou 1
...
Race on lines setting processing to true.
...
struct Work {
    bool *processing;
    int data;
    Work() : processing(new bool(false)), data(0) {}
    ~Work() { delete processing; }
};
