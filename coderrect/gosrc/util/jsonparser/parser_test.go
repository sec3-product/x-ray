...
func TestSetAndGet(t *testing.T) {
	...
	cmdlineConf, err = Set(cmdlineConf, []byte(`"http://github.com"`), "test")
	v, err := GetString(cmdlineConf, "test")
	if err != nil {
	...
	value = "\"abc\""
	cmdlineConf, err = Set(cmdlineConf, []byte(value), "stage1", "stage2")
	v, err = GetString(cmdlineConf, "stage1", "stage2")
	if err != nil {
		fmt.Printf("error %v", err)
		return
	}
