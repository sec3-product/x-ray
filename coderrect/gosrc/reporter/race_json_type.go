...
func (r *FullReport) bugNum() int {
	return len(r.DataRaces) + len(r.MismatchedAPIs) + len(r.TocTous)
}
...
func (r *RaceCondition) ComputeSignature() string {
	...
	builder.WriteString(r.Access3.Filename)
