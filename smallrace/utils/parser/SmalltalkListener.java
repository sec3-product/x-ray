...
public interface SmalltalkListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#module}.
	 * @param ctx the parse tree
	 */
	void enterModule(SmalltalkParser.ModuleContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#module}.
	 * @param ctx the parse tree
	 */
	void exitModule(SmalltalkParser.ModuleContext ctx);
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#function}.
	 * @param ctx the parse tree
	 */
	void enterFunction(SmalltalkParser.FunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#function}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#temps1}.
	 * @param ctx the parse tree
	 */
	void enterTemps1(SmalltalkParser.Temps1Context ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#temps1}.
	 * @param ctx the parse tree
	 */
	void exitTemps1(SmalltalkParser.Temps1Context ctx);
	/**
	 * Enter a parse tree produced by {@link SmalltalkParser#temps2}.
	 * @param ctx the parse tree
	 */
	void enterTemps2(SmalltalkParser.Temps2Context ctx);
	/**
	 * Exit a parse tree produced by {@link SmalltalkParser#temps2}.
	 * @param ctx the parse tree
	 */
	void exitTemps2(SmalltalkParser.Temps2Context ctx);
	/**
